...
public sealed class DateTimeExtensionsTests : TestBase
{
    ...
    {
        DateTime date = new(year: 2021, month: 1, day: 1, hour: 0, minute: 0, second: 0, kind: DateTimeKind.Utc);
    ...
    {
        DateTime date = new(year: 2021, month: 1, day: 1, hour: 0, minute: 0, second: 0, kind: dateTimeKind);
